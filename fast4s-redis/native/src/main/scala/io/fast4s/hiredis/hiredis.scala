...
object predef:
    private[hiredis] trait _BindgenEnumCUnsignedInt[T](using eq: T =:= CUnsignedInt):
...
object aliases:
  import _root_.hiredis.enumerations.*
  import _root_.hiredis.predef.*
  import _root_.hiredis.aliases.*
  import _root_.hiredis.structs.*
...
@extern
private[hiredis] object extern_functions:
  import _root_.hiredis.enumerations.*
  import _root_.hiredis.predef.*
  import _root_.hiredis.aliases.*
  import _root_.hiredis.structs.*
  private[hiredis] def __sn_wrap_hiredis_hiredisSetAllocators(ha : Ptr[hiredisAllocFuncs], __return : Ptr[hiredisAllocFuncs]): Unit = extern
...
object functions:
  ...
  def hiredisSetAllocators(ha : Ptr[hiredisAllocFuncs])(__return : Ptr[hiredisAllocFuncs]): Unit =
    __sn_wrap_hiredis_hiredisSetAllocators(ha, __return)
  ...
  def hiredisSetAllocators(ha : Ptr[hiredisAllocFuncs])(using Zone): hiredisAllocFuncs =
    ...
    __sn_wrap_hiredis_hiredisSetAllocators(ha, (__ptr_0 + 0))
    !(__ptr_0 + 0)

object types:
    export _root_.hiredis.structs.*
    export _root_.hiredis.aliases.*
    export _root_.hiredis.enumerations.*

object all:
  export _root_.hiredis.enumerations.redisConnectionType
  export _root_.hiredis.aliases.redisAsyncPushFn
  export _root_.hiredis.aliases.redisFD
  export _root_.hiredis.aliases.redisPushFn
  export _root_.hiredis.aliases.sds
  export _root_.hiredis.aliases.size_t
  export _root_.hiredis.aliases.ssize_t
  export _root_.hiredis.aliases.timeval
  export _root_.hiredis.aliases.uint16_t
  export _root_.hiredis.aliases.uint32_t
  export _root_.hiredis.aliases.uint64_t
  export _root_.hiredis.aliases.uint8_t
  export _root_.hiredis.aliases.va_list
  export _root_.hiredis.structs.hiredisAllocFuncs
  export _root_.hiredis.structs.redisAsyncContext
  export _root_.hiredis.structs.redisContext
  export _root_.hiredis.structs.redisContextFuncs
  export _root_.hiredis.structs.redisOptions
  export _root_.hiredis.structs.redisReadTask
  export _root_.hiredis.structs.redisReader
  export _root_.hiredis.structs.redisReply
  export _root_.hiredis.structs.redisReplyObjectFunctions
  export _root_.hiredis.structs.redisSsl
  export _root_.hiredis.structs.sdshdr16
  export _root_.hiredis.structs.sdshdr32
  export _root_.hiredis.structs.sdshdr5
  export _root_.hiredis.structs.sdshdr64
  export _root_.hiredis.structs.sdshdr8
  export _root_.hiredis.structs.sockaddr
  export _root_.hiredis.functions.freeReplyObject
  export _root_.hiredis.functions.hi_calloc
  export _root_.hiredis.functions.hi_free
  export _root_.hiredis.functions.hi_malloc
  export _root_.hiredis.functions.hi_realloc
  export _root_.hiredis.functions.hi_strdup
  export _root_.hiredis.functions.hiredisResetAllocators
  export _root_.hiredis.functions.redisAppendCommand
  export _root_.hiredis.functions.redisAppendCommandArgv
  export _root_.hiredis.functions.redisAppendFormattedCommand
  export _root_.hiredis.functions.redisBufferRead
  export _root_.hiredis.functions.redisBufferWrite
  export _root_.hiredis.functions.redisCommand
  export _root_.hiredis.functions.redisCommandArgv
  export _root_.hiredis.functions.redisConnect
  export _root_.hiredis.functions.redisConnectBindNonBlock
  export _root_.hiredis.functions.redisConnectBindNonBlockWithReuse
  export _root_.hiredis.functions.redisConnectFd
  export _root_.hiredis.functions.redisConnectNonBlock
  export _root_.hiredis.functions.redisConnectUnix
  export _root_.hiredis.functions.redisConnectUnixNonBlock
  export _root_.hiredis.functions.redisConnectUnixWithTimeout
  export _root_.hiredis.functions.redisConnectWithOptions
  export _root_.hiredis.functions.redisConnectWithTimeout
  export _root_.hiredis.functions.redisEnableKeepAlive
  export _root_.hiredis.functions.redisEnableKeepAliveWithInterval
  export _root_.hiredis.functions.redisFormatCommand
  export _root_.hiredis.functions.redisFormatCommandArgv
  export _root_.hiredis.functions.redisFormatSdsCommandArgv
  export _root_.hiredis.functions.redisFree
  export _root_.hiredis.functions.redisFreeCommand
  export _root_.hiredis.functions.redisFreeKeepFd
  export _root_.hiredis.functions.redisFreeSdsCommand
  export _root_.hiredis.functions.redisGetReply
  export _root_.hiredis.functions.redisGetReplyFromReader
  export _root_.hiredis.functions.redisReaderCreate
  export _root_.hiredis.functions.redisReaderCreateWithFunctions
  export _root_.hiredis.functions.redisReaderFeed
  export _root_.hiredis.functions.redisReaderFree
  export _root_.hiredis.functions.redisReaderGetReply
  export _root_.hiredis.functions.redisReconnect
  export _root_.hiredis.functions.redisSetPushCallback
  export _root_.hiredis.functions.redisSetTcpUserTimeout
  export _root_.hiredis.functions.redisSetTimeout
  export _root_.hiredis.functions.redisvAppendCommand
  export _root_.hiredis.functions.redisvCommand
  export _root_.hiredis.functions.redisvFormatCommand
  export _root_.hiredis.functions.sdsAllocPtr
  export _root_.hiredis.functions.sdsAllocSize
  export _root_.hiredis.functions.sdsIncrLen
  export _root_.hiredis.functions.sdsMakeRoomFor
  export _root_.hiredis.functions.sdsRemoveFreeSpace
  export _root_.hiredis.functions.sds_free
  export _root_.hiredis.functions.sds_malloc
  export _root_.hiredis.functions.sds_realloc
  export _root_.hiredis.functions.sdsalloc
  export _root_.hiredis.functions.sdsavail
  export _root_.hiredis.functions.sdscat
  export _root_.hiredis.functions.sdscatfmt
  export _root_.hiredis.functions.sdscatlen
  export _root_.hiredis.functions.sdscatprintf
  export _root_.hiredis.functions.sdscatrepr
  export _root_.hiredis.functions.sdscatsds
  export _root_.hiredis.functions.sdscatvprintf
  export _root_.hiredis.functions.sdsclear
  export _root_.hiredis.functions.sdscmp
  export _root_.hiredis.functions.sdscpy
  export _root_.hiredis.functions.sdscpylen
  export _root_.hiredis.functions.sdsdup
  export _root_.hiredis.functions.sdsempty
  export _root_.hiredis.functions.sdsfree
  export _root_.hiredis.functions.sdsfreesplitres
  export _root_.hiredis.functions.sdsfromlonglong
  export _root_.hiredis.functions.sdsgrowzero
  export _root_.hiredis.functions.sdsinclen
  export _root_.hiredis.functions.sdsjoin
  export _root_.hiredis.functions.sdsjoinsds
  export _root_.hiredis.functions.sdslen
  export _root_.hiredis.functions.sdsmapchars
  export _root_.hiredis.functions.sdsnew
  export _root_.hiredis.functions.sdsnewlen
  export _root_.hiredis.functions.sdsrange
  export _root_.hiredis.functions.sdssetalloc
  export _root_.hiredis.functions.sdssetlen
  export _root_.hiredis.functions.sdssplitargs
  export _root_.hiredis.functions.sdssplitlen
  export _root_.hiredis.functions.sdstolower
  export _root_.hiredis.functions.sdstoupper
  export _root_.hiredis.functions.sdstrim
  export _root_.hiredis.functions.sdsupdatelen
  export _root_.hiredis.functions.hiredisSetAllocators